...
public class SecondActivity extends LiveBaseActivity implements AdapterView.OnItemClickListener{
				...
				if(mSearchBtn.getText().toString().equals("搜索")){
					...
					MyRountListAdapter adapter = new MyRountListAdapter(this,
							GlobaleData.getMyRouontListData(), new String[] { "leftimg",
									"lines", "title", "text1","text2" }, new int[] { R.id.left_img,
									R.id.mlines, R.id.title, R.id.text1,R.id.text2 });
					mSearchResultList.setAdapter(adapter);
				}else if(mSearchBtn.getText().toString().equals("取消")){
					mSearchBtn.setText("搜索");
					mSearchBtn.setBackgroundResource(R.drawable.search_nothing_btn);
					mSearchResultList.setVisibility(android.view.View.INVISIBLE);
	...
	private void InitTitle(){
		...
		mRightBtn.setBackgroundResource(R.drawable.shape_button_white);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LayoutAdapter ia = new LayoutAdapter(this,mImageIds,mStringIds,mCountNumbers);
