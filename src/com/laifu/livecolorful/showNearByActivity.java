...
public class showNearByActivity extends Activity implements Button.OnClickListener{
	...
	public void InitMyListView(){
		...
		MyRountListAdapter adapter = new MyRountListAdapter(this,
				GlobaleData.getMyNearByData(), new String[] { "leftimg",
						"lines", "title", "img1","text1" }, new int[] { R.id.left_img,
						R.id.mlines, R.id.title, R.id.img1,R.id.text1 });
